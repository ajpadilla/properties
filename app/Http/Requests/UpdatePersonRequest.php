...
class UpdatePersonRequest extends FormRequest
{
    ...
    {
        return [
            'identification_number' => 'required|min:1|max:45|unique:persons,identification_number,'.$this->id,
            ...
            'home_email' => 'required|min:1|max:30|email|unique:persons,home_email,'.$this->id,
